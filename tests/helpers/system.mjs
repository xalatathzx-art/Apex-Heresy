...
import {targetSizeModifier, sizeToHitModifier, wearsTerminatorArmour} from '../../script/data/size-rules.mjs';
...
export function loadSystem(overrides = {}) {
    ...
    const context = vm.createContext({
        ...
        patronOf, targetSizeModifier, sizeToHitModifier, wearsTerminatorArmour,
